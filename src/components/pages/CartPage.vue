  ...
  <div class="cart-page">
    <div class="container">
      <header class="cart-header">
        ...
        <span class="item-count" v-if="!isLoading"
      ...
      <div v-else class="cart-main-layout">
              ...
              >
                <div class="item-main" @click="goToDetail(item.productId)">
                  ...
                  <div class="item-info">
                    ...
                    <button
                      @click.stop="confirmRemove(item.cartId)"
          ...
          <div v-else class="empty-cart-container">
            <div class="empty-cart-card">
              ...
              <p class="empty-description">
                Find your favorite Vans and add to cart before checking out.
              </p>
        ...
        <aside class="cart-sidebar">
          <div
            class="summary-card"
            :class="{ 'summary-disabled': cartItems.length === 0 }"
          >
            ...
            <div class="summary-details">
              ...
              <div class="summary-line">
                ...
                <span>{{
                  cartItems.length > 0 ? formatPrice(20000) : "Rp0"
                }}</span>
              </div>
              <div class="summary-total">
                <span class="total-label">Total Payment</span>
                <span class="total-value">{{
                  formatPrice(cartItems.length > 0 ? totalPrice + 20000 : 0)
                }}</span>
              </div>
            </div>
            <button
          ...
          >
            ...
            <div class="card-body">
              ...
              <div class="p-meta">
                ...
                <span class="p-likes"
                  ><i class="fa-regular fa-heart"></i> 12</span
                >
              </div>
            </div>
          </div>
  ...
  methods: {
    async fetchData(user) {
      ...
      try {
        ...
        this.cartItems = cartSnapshot.exists()
          ? Object.keys(cartSnapshot.val()).map((key) => ({
              cartId: key,
        ...
        this.otherProducts = productSnapshot.exists()
          ? Object.keys(productSnapshot.val())
              .slice(0, 8)
              .map((key) => ({
                id: key,
    ...
    async updateQty(item, change) {
      ...
      try {
        await update(
          dbRef(rtdb, `carts/${this.currentUser.uid}/${item.cartId}`),
          { qty: newQty }
        );
        item.qty = newQty;
      } catch (e) {
    ...
    goToOrderConfirmation() {
      ...
      // Tandai bahwa ini adalah checkout dari keranjang (Cart Mode)
      localStorage.setItem("vans_checkout_mode", "cart");
